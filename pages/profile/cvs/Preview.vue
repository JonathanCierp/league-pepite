<template>
  <main class="max-w-5xl mx-auto my-4 lg:my-10 px-4 lg:px-0 flex flex-col">
      ...
      <h3 class="text-xl uppercase text-center">{{ cvForm.job }}</h3>
       <div class="flex justify-between mt-6 relative text-sm">
          ...
          <img
            ...
            src="~/assets/img/flyer-pepite.png"
          >
    ...
    <section class="flex justify-between mt-6">
      <div class="w-2/5">
        ...
        <p class="text-sm mt-4">{{ cvForm.informations }}</p>
      </div>
      <div class="w-2/5">
        <div class="flex justify-center">
      ...
      <div v-for="education in cvForm.educations" class="flex text-sm mt-5">
        <div class="flex mr-4">
          <div class="w-36 mr-4 font-bold">
            ...
            <div>
              {{ convertDateToYear(education.start_at) }}
              -
